...
//GET TASKS ACTION
export const taskLoadsInitAction = () => {
    return {type: INIT_TASKS_LOAD}
};

export const taskLoadsStartAction = () => {
    return {type: INIT_TASKS_START_LOAD};
};

export const taskLoadsSuccessAction = (payload) => {
    return {type: INIT_TASKS_SUCCESS_LOAD, payload};
};

export const taskLoadsErrorAction = (error) => {
    return {type: INIT_TASKS_ERROR_LOAD, error};
};

export const formOnChangeAction = (data) => {
